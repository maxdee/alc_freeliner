...
keyMap[44] = {key:",", name:"showTags", cmd:"tools tags", max:"-42", desc:"showTags of all groups"};
keyMap[45] = {key:"-", name:"decrease", cmd:"nope", max:"-42", desc:"Decrease value of selectedKey."};
keyMap[46] = {key:".", name:"snapping", cmd:"tools snap", max:"255", desc:"enable/disable snapping or set the snapping distance"};
keyMap[47] = {key:"/", name:"showLines", cmd:"tools lines", max:"-42", desc:"Showlines of all geometry."};
keyMap[60] = {key:"<", name:"sequencer", cmd:"seq select", max:"16", desc:"select sequencer steps to add or remove templates"};
keyMap[61] = {key:"=", name:"increase", cmd:"nope", max:"-42", desc:"Increase value of selectedKey."};
keyMap[62] = {key:">", name:"play", cmd:"seq play", max:"-42", desc:"toggle auto loops and sequencer"};
keyMap[63] = {key:"?", name:"???", cmd:"fl random", max:"-42", desc:"~:)"};
keyMap[65] = {key:"A", name:"selectAll", cmd:"??set*??", max:"-42", desc:"Select ALL the templates."};
keyMap[67] = {key:"C", name:"copy", cmd:"tp copy $", max:"-42", desc:"Copy first selected template into second selected."};
keyMap[68] = {key:"D", name:"customShape", cmd:"tp shape $", max:"1000", desc:"Set a template's customShape."};
keyMap[73] = {key:"I", name:"revMouseX", cmd:"tools revx", max:"-42", desc:"Reverse the X axis of mouse, trust me its handy."};
keyMap[77] = {key:"M", name:"mask", cmd:"layer mask", max:"-42", desc:"Generate mask for maskLayer, or set mask."};
keyMap[79] = {key:"O", name:"open", cmd:"fl open", max:"-42", desc:"Open stuff"};
keyMap[82] = {key:"R", name:"reset", cmd:"tp reset $", max:"-42", desc:"Reset template."};
keyMap[83] = {key:"S", name:"save", cmd:"fl save", max:"-42", desc:"Save stuff."};
keyMap[88] = {key:"X", name:"swap", cmd:"tp swap $", max:"-42", desc:"Completely swap template tag, with `AB` A becomes B and B becomes A."};
keyMap[91] = {key:"[", name:"fixedAngle", cmd:"tools angle", max:"360", desc:"enable/disable fixed angles for the mouse"};
keyMap[93] = {key:"]", name:"fixedLength", cmd:"tools ruler", max:"5000", desc:"enable/disable fixed length for the mouse"};
keyMap[94] = {key:"^", name:"clear", cmd:"seq clear $", max:"-42", desc:"clear sequencer"};
keyMap[97] = {key:"a", name:"animation", cmd:"tw $ a", max:"10", desc:"animate stuff"};
keyMap[98] = {key:"b", name:"renderMode", cmd:"tw $ b", max:"6", desc:"picks the renderMode"};
keyMap[99] = {key:"c", name:"placeCenter", cmd:"geom center", max:"-42", desc:"Place the center of geometry on next left click, right click uncenters the geometry, middle click sets scene center."};
keyMap[100] = {key:"d", name:"breakline", cmd:"geom breakline", max:"-42", desc:"Detach line to new starting position."};
keyMap[101] = {key:"e", name:"enterpolator", cmd:"tw $ e", max:"10", desc:"Enterpolator picks a position along a segment"};
keyMap[102] = {key:"f", name:"fill", cmd:"tw $ f", max:"31", desc:"Pick fill color"};
keyMap[103] = {key:"g", name:"grid", cmd:"tools grid", max:"255", desc:"use snappable grid"};
keyMap[104] = {key:"h", name:"easing", cmd:"tw $ h", max:"11", desc:"Set the easing mode."};
keyMap[105] = {key:"i", name:"iteration", cmd:"tw $ i", max:"6", desc:"Iterate animation in different ways, `r` sets the amount."};
keyMap[106] = {key:"j", name:"reverse", cmd:"tw $ j", max:"5", desc:"Pick different reverse modes"};
keyMap[107] = {key:"k", name:"strokeAlpha", cmd:"tw $ k", max:"256", desc:"Alpha value of stroke."};
keyMap[108] = {key:"l", name:"fillAlpha", cmd:"tw $ l", max:"256", desc:"Alpha value of fill."};
keyMap[109] = {key:"m", name:"miscValue", cmd:"tw $ m", max:"1000", desc:"A extra value that can be used by modes."};
keyMap[110] = {key:"n", name:"new", cmd:"geom new", max:"-42", desc:"make a new geometry group"};
keyMap[111] = {key:"o", name:"rotation", cmd:"tw $ o", max:"12", desc:"Rotate stuff."};
keyMap[112] = {key:"p", name:"layer", cmd:"tw $ p", max:"3", desc:"Pick which layer to render on."};
keyMap[113] = {key:"q", name:"strokeColor", cmd:"tw $ q", max:"31", desc:"Pick the stroke Color."};
keyMap[114] = {key:"r", name:"polka", cmd:"tw $ r", max:"10000000", desc:"Number of iterations for the iterator, related to `i`."};
keyMap[115] = {key:"s", name:"size", cmd:"tw $ s", max:"5000", desc:"Sets the brush size for `b-0`"};
keyMap[116] = {key:"t", name:"tap", cmd:"seq tap", max:"1000", desc:"Tap tempo, tweaking nudges time."};
keyMap[117] = {key:"u", name:"enabler", cmd:"tw $ u", max:"7", desc:"Enablers decide if a render happens or not."};
keyMap[118] = {key:"v", name:"segSelect", cmd:"tw $ v", max:"7", desc:"Picks which segments get rendered."};
keyMap[119] = {key:"w", name:"strokeWeight", cmd:"tw $ w", max:"420", desc:"Stroke weight."};
keyMap[120] = {key:"x", name:"beatMultiplier", cmd:"tw $ x", max:"5000", desc:"Set how many beats the animation will take."};
keyMap[121] = {key:"y", name:"tracers", cmd:"post tracers", max:"256", desc:"Set tracer level for tracer layer."};
keyMap[124] = {key:"|", name:"enterText", cmd:"text", max:"-42", desc:"enable text entry, type text and press return"};
